...
import {SetCheckResult} from "./SetCheckResult.js";

export class SelectionList extends CardList {

    /* SetCheckResult */ _setCheckResult
    ...
    addCardFromDeck(/* CardList */ deckToUse, idOfCardToAdd) {
        const card =  deckToUse.findByID(idOfCardToAdd);
        if (card !== undefined) {
            this.add(card);
        }
    }
